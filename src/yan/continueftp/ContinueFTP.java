...
public class ContinueFTP {
	...
	public static void main(String[] args) {
		...
		try {
			myFtp.connect("202.114.171.38", 21, "ftpxiaoyan", "880125");
			myFtp.ftpClient.makeDirectory(new String("视频文件".getBytes("GBK"),
					"iso-8859-1"));
			myFtp.ftpClient.changeWorkingDirectory(new String("视频文件"
					.getBytes("GBK"), "iso-8859-1"));
			
			/** 上传文件 **/
			System.out.println(myFtp.upload("G:\\Downloads\\AdbeRdr90_zh_CN.exe",
					"/视频/AdbeRdr90_zh_CN.exe"));
			
			
			/** 下载文件 **/
			 System.out.println(myFtp.download("/ftpxiaoyan/AdbeRdr90_zh_CN.exe",
			 "D:\\binfile\\AdbeRdr90_zh_CN.exe"));
			myFtp.disconnect();
		} catch (IOException e) {
